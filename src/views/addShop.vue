		        ...
		        <el-form :model="formData" :rules="rules" ref="formData" label-width="110px" class="demo-formData">
					...
					<el-form-item label="上传店铺头像">
						<el-upload
						  ...
						  <img v-if="formData.image_path" :src="imgBaseUrl + formData.image_path" class="avatar">
					...
					<el-form-item label="上传营业执照">
						<el-upload
						  ...
						  :before-upload="beforeAvatarUpload">
						  <img v-if="formData.business_license_image" :src="imgBaseUrl + formData.business_license_image" class="avatar">
						  <i v-else class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
					</el-form-item>
					<el-form-item label="上传餐饮服务许可证">
						<el-upload
						  ...
						  :before-upload="beforeAvatarUpload">
						  <img v-if="formData.catering_service_license_image" :src="imgBaseUrl + formData.catering_service_license_image" class="avatar">
						  <i v-else class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
					</el-form-item>
...
<script>
    ...
    import {cityGuess, addShop, searchplace, foodCategory} from '@/service/getDataAdmin'
